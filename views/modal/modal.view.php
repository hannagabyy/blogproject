        ...
        <div class="modal-content">
            <form data-target="#exampleModal" id="form-modal" method="post" onsubmit="desabilitarBotao()" action="\Blog_project\public\post\cadastrar_post.php">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" id="submitPost"class="btn btn-primary col-2 botao__postar btn text-white d-flex justify-content-center align-items-center">Postar <img class="ms-2" src="\Blog_project\imagens\correct-icon.svg" alt="Ícone de correto no botão de postar"> </button>
                </div>
            </form>
        </div>
    </div>
